        ...
        <div className="p-6 space-y-6">
          ...
          <div className="border-t border-[var(--outline-variant)] pt-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-2 items-end">
                ...
                <Button variant="secondary" size="sm" onClick={() => setMediaOpen('og')} data-testid="post-form-og-browse">Browse</Button>
              </div>
            </div>
          </div>
          ...
          <div className="border-t border-[var(--outline-variant)] pt-6">
            ...
            <div className="flex items-center gap-3">
              <Button variant="secondary" size="sm" onClick={() => setMediaOpen('featured')} data-testid="post-form-image-select">Browse</Button>
              {featuredImageUrl && (
                <div className="flex items-center gap-2">
                  ...
                  <button type="button" onClick={() => { setFeaturedImageId(null); setFeaturedImageUrl(''); markDirty() }} className="text-xs text-red-500 hover:text-red-700" data-testid="post-form-image-remove">Remove</button>
                </div>
              )}
            </div>
            {featuredImageUrl && (
